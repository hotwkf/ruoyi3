...
function moveToTarget(currentTag: any) {
  ...
  if (firstTag === currentTag) {
    ...
    const beforePreviousTagOffsetLeft =
      previousTag.offsetLeft - tagAndTagSpacing.value;
    if (afterNextTagOffsetLeft > $scrollWrapper.scrollLeft + $containerWidth) {
      $scrollWrapper.scrollLeft = afterNextTagOffsetLeft - $containerWidth;
    } else if (beforePreviousTagOffsetLeft < $scrollWrapper.scrollLeft) {
      $scrollWrapper.scrollLeft = beforePreviousTagOffsetLeft;
    }
  }
}
